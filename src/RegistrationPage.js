...
const RegistrationPage = () => {
  ...
  const validationSchema = Yup.object({
    ...
    phoneNumber: Yup.string().required('Phone Number is required').min(10, "must be 10 digits"),
            ...
            <Grid item xs={12} sm={6} sx={{ display: 'flex', justifyContent: isSmallScreen ? 'center' : 'flex-start', width: isSmallScreen ? '80%' : 'auto', margin: isSmallScreen ? '0 auto' : '0' }}>
              <TextField
                ...
                onChange={(e) => {
                  ...
                  formik.setFieldValue('phoneNumber', formattedPhoneNumber.slice(0, 10)); // Limit to 11 digits
                }}
                InputProps={{
