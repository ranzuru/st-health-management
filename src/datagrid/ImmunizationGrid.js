...
const ImmunizationGrid = () => {
  ...
  const columns = [
    ...
    { field: 'tetanus', headerName: 'Tetanus', width: 100 },
    { field: 'mmr', headerName: 'MMR', width: 100 },
    { field: 'hepa', headerName: 'Hepa B', width: 100 },
    { field: 'polio', headerName: 'Polio', width: 100 },
    { field: 'chickenpox', headerName: 'Chickenpox', width: 100 },
    { field: 'influenza', headerName: 'Influenza', width: 100 },
    {
      field: 'action',
      headerName: 'Action',
      width: 150,
  ...
  const FilterImmunization = immunizationPatients.filter(user => 
