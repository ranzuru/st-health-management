...
const DengueMonitoringGrid = () => {
  ...
  const denguePatients = [
    {
        ...
        grade: '2',
        section: 'Mabait',
        address: "151 Engracia Reyes St, Ermita, Manila, Metro Manila, Philippines",
        onset: '06-24-2022',
     ...
     
      {
        ...
        grade: '5',
        section: 'Mabait',
        address: "345 Commonwealth Avenue, Quezon City, Metro Manila, Philippines",
        onset: '02-10-2022',
     ...
     
      {
         ...
         grade: '4',
         section: 'Mabait',
         address: "789 Tomas Morato Avenue, Quezon City, Metro Manila, Philippines",
         onset: '07-24-2022',
     ...
     
      {
         ...
         grade: '3',
         section: 'Magalang',
         address: "890 Shaw Boulevard, Mandaluyong City, Metro Manila, Philippines",
         onset: '01-14-2022',
     ...
     
      {
         ...
         grade: '3',
         section: 'Mabait',
         address: "789 Mabini Street, Bacolod City, Negros Occidental, Philippines",
         onset: '03-05-2022',
  ...
  const filteredDengue = denguePatients.filter(user => 
